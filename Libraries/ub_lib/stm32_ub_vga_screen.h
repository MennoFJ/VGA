...
void UB_VGA_drawEllipse(uint16_t xmp,uint16_t ymp,uint16_t x_radius, uint16_t y_radius, uint8_t color);
void UB_VGA_drawRectangle(uint16_t x_lo,uint16_t y_lo,uint16_t x_rb, uint16_t y_rb, uint8_t color);
void UB_VGA_drawTraingle(uint16_t x_one,uint16_t y_one,uint16_t x_two, uint16_t y_two ,uint16_t x_tree, uint16_t y_tree, uint8_t color);
//@TODO datatypes for text are not right
void UB_VGA_drawText(uint16_t x_start,uint16_t y_start, uint16_t x_fontname, uint16_t style , uint8_t color);
void UB_VGA_setBitmap(uint8_t img_number,uint16_t x_start, uint16_t y_start);
